...
def get_siamese_dataloaders(data_config_dir, model_config_dir, fold_idx):
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_siamese_dataloaders(data_config_dir, model_config_dir, fold_idx)
