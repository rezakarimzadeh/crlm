...
from utils_morphresponse import MR_test_model
...
def train_dl_model(args, fold_index: int):
    ...
    model = MorphScoreGooglenetLSTM(config_dir=model_config_dir)
    ...
    #  Test
    best_model = MorphScoreGooglenetLSTM.load_from_checkpoint(ckpt.best_model_path, config_dir=model_config_dir, weights_only=False)
    test_output = MR_test_model(best_model, test_loader)
...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="MorphScoreGooglenetLSTM", choices=["MorphScoreGooglenetLSTM"], help="model name to use.")
