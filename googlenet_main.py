...
def train_dl_model(args, fold_index: int):
    ...
    model = GooglenetLSTM(config_dir=model_config_dir, target_key=target_key)
    ...
    #  Test
    best_model = GooglenetLSTM.load_from_checkpoint(ckpt.best_model_path, config_dir=model_config_dir, target_key=target_key, weights_only=False)
