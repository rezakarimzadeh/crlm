...
from utils_morphresponse import MR_rpn3d_test_model
...
def train_dl_model(args, fold_index: int):
    ...
    model = MorphScoreRPNetLightning(config_dir=model_config_dir)
    ...
    #  Test
    best_model = MorphScoreRPNetLightning.load_from_checkpoint(ckpt.best_model_path, config_dir=model_config_dir, weights_only=False)
    test_output = MR_rpn3d_test_model(best_model, test_loader)
